...
<a target="_blank" href="https://github.com/rfc-st/humble/screenshots/humble_dependabot.jpg" title="Alerts enabled for vulnerabilities of the dependencies required by this tool"><img src="https://badgen.net/github/dependabot/rfc-st/humble"></a>  
...
:heavy_check_mark: 345 [checks](#checks-fingerprint-headers) of fingerprinting through HTTP response headers.<br />
