...
<a target="_blank" href="https://github.com/rfc-st/humble/?tab=readme-ov-file#unit-tests" title="humble code coverage"><img src="https://img.shields.io/badge/code%20coverage-73%25-f9d71c?labelColor=343b41"></a>
...
> [!NOTE]
> After reviewing the code coverage, you can delete all files and folders from the *tests* directory except for the *.coveragerc*, *headers_test_file.txt* and *test_basic.py* files.
