...
:heavy_check_mark: 28 checks of deprecated HTTP response headers or with values considered insecure.<br />
...
| `X-FEServer` | `X-FW-Dynamic` | `X-FW-Hash` |
| `X-FW-Serve` | `X-FW-Server` | `X-FW-Static` |
| `X-FW-Type` | `X-FW-Version` | `X-Garden-Version` |
...
| `X-Magento-Cache-Debug` | `X-Magnolia-Registration` | `X-LiteSpeed-Purge` |
