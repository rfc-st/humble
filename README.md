...
<a target="_blank" href="https://github.com/rfc-st/humble/commits/master" title="Latest commit of this tool"><img src="https://img.shields.io/badge/Latest_Commit-2026--04--25-blue.svg?labelColor=343b41"></a>
...
:heavy_check_mark: [AI](#AI)-powered security analytics option.<br />
...
To perform a senior-level debrief among your IA:

* Upload or paste the contents of this <a href="https://github.com/rfc-st/humble/blob/master/ai/SKILL.md">SKILL</a> into your AI chat; or create a `persona` based on that file.
* Provide the complete txt-based analysis generated by `humble`; make sure it was generated in **English** and includes the HTTP response headers (use the `-o txt -r` flags).
* Get Results!.

Once you've followed these steps, you'll be able to (based on a .txt file analysis):
...
get tips, guides, and recommendations from your favorite AI assistant; the following screenshots show interactions with Gemini:
