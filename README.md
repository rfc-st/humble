...
* Paste the included <a href="https://github.com/rfc-st/humble/blob/master/humble-header-analyst/SKILL.md">SKILL.MD</a> content into your chat (or set up a custom Persona).
