...
<a target="_blank" href="https://github.com/rfc-st/humble/commits/master" title="Latest commit of this tool"><img src="https://img.shields.io/badge/Latest_Commit-2025--12--06-blue.svg?labelColor=343b41"></a>
...
<a target="_blank" href="https://github.com/rfc-st/humble/?tab=readme-ov-file#unit-tests" title="humble code coverage"><img src="https://img.shields.io/badge/code%20coverage-80%25-f9d71c?labelColor=343b41"></a>
...
# Build the Docker image inside the 'humble' folder: providing the TAG as the latest Release of 'humble' (e.g. 1.55)
# https://github.com/rfc-st/humble/releases (On Windows, this may require running the terminal with admin privileges)
$ docker build -t humble:1.55 .
...
$ docker run -it --rm --name humble humble:1.55 /bin/bash -c "python3 humble.py -u https://google.com -b"

# (Windows)
# E.g. Analyze https://google.com (detailed analysis)
$ docker run -it --rm --name humble humble:1.55 python3 humble.py -u https://google.com

# (Optional) Remove and untag the previous 'humble' image after upgrading
$ docker rmi humble:1.55
```
...
> [!NOTE]
> After reviewing the code coverage, you can delete all files and folders from the *tests* directory except for the *.coveragerc*, *analysis_h.txt*, *headers_test_file.txt* and *test_basic.py* files: if these files are deleted, the tests will fail.
