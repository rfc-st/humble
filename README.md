...
:heavy_check_mark: 130 checks of fingerprinting through HTTP response headers.<br />
...
| `X-Magnolia-Registration` | `X-LiteSpeed-Purge` | `X-LiteSpeed-Tag` |
...
| `X-Nitro-Disabled` | `X-Nitro-Disabled-Reason` | `X-Nitro-Expires` |
