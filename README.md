...
:heavy_check_mark: 77 checks of fingerprinting through HTTP response headers.<br />
...
||||
| ------------- | ------------- | ------------- |
| `Hummingbird-Cache` | `Liferay-Portal` | `MicrosoftOfficeWebServer` |
| `MicrosoftSharePointTeamServices` | `MS-Author-Via` | `Oracle-Mobile-Runtime-Version` |
| `Powered-By` | `Server` | `Servlet-Engine` | 
