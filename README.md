...
:heavy_check_mark: 221 checks of fingerprinting through HTTP response headers.<br />
:heavy_check_mark: 40 checks of deprecated HTTP response headers/protocols or with values considered insecure.<br />
...
:heavy_check_mark: i18n: analysis results in English or Spanish (Work In Progress).<br />
