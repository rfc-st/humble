...
:heavy_check_mark: 104 checks of fingerprinting through HTTP response headers.<br />
...
| `X-Cache-Only-Varnish` | `X-CF-Powered-By` | `X-CMS-Version` |
...
| `X-Generator` | `X-Hudson` | `X-Jenkins` |
